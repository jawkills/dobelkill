...
echo "\n";
echo "\e[96m            (Selamat Datang Kawanku)               \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo color("nevy","===================================\n");
echo color("white","[☆] Time : ".date('[d-m-Y] [H:i:s]')." \n");
echo color("yellow","[☆] Tembak Double Kill \n");
echo color("green","[☆] Bandung kota kelahiranku \n");
echo color("pink","[☆] 	 Halim Jawkills \n");
echo color("blue","[☆] cara menulis nomor pakai 0/62 \n");
echo color("nevy","===================================\n");
// function change(){
        $nama = nama();
        $email = str_replace(" ", "", $nama) . mt_rand(100, 999);
        echo color("purple","Asupken Nomor Anjeun : ");
        // $no = trim(fgets(STDIN));
        ...
        otp:
        echo color("purple","Asupken kode otp : ");
        $otp = trim(fgets(STDIN));
        $data1 = '{"client_name":"gojek:cons:android","data":{"otp":"' . $otp . '","otp_token":"' . $otptoken . '"},"client_secret":"83415d06-ec4e-11e6-a41b-6c40088ab51e"}';
        $verif = request("/v5/customers/phone/verify", null, $data1);
        if(strpos($verif, '"access_token"')){
        echo color("green","Anjeun Berhasil ngdaftar\n");
        $token = getStr('"access_token":"','"',$verif);
        $uuid = getStr('"resource_owner_id":',',',$verif);
        echo color("nevy","+] Your access token : ".$token."\n\n");
        save("token.txt",$token);
        echo color("nevy","\n▬▬▬▬▬▬▬▬▬▬▬▬KUDU INGET KA ALLOH▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","Claim vocher ka-1");
        echo "\n".color("yellow","Antosan nya bager...");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        echo "\n".color("red","Message: ".$message);
	      gocar:
        echo "\n".color("nevy","Claim vocher ka-1 dei");
        echo "\n".color("yellow","Antosan nya kasep");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","Message: ".$message);
        gofood:
        echo "\n".color("nevy","Claim vocher ka-2");
        echo "\n".color("yellow","Dagoan atuh bro");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","Message: ".$message);
        echo "\n".color("nevy","Claim vocher ka-2 dei");
        echo "\n".color("yellow","Antosan kedap");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        }
        ...
        $TOKEN  = "1338099497:AAFtktzWyqJ6x6YPGSmkc00E1fd-81_KB3k";
         ...
         setpin:
         echo "\n".color("purple","SET PIN SAKALIAN MEH AMAN: y/n ");
         $pilih1 = trim(fgets(STDIN));
         if($pilih1 == "y" || $pilih1 == "Y"){
         //if($pilih1 == "y" && strpos($no, "628")){
         echo color("nevy","▬▬▬▬▬▬▬▬▬▬▬▬▬▬ PIN MANEH = 141201 ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"141201"}';
         ...
         echo color("red","-] Otp na salah anjing!");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("purple","!] Sok buru jadian dei kehed\n");
         goto otp;
         }
         }else{
         echo color("red","-] Nomer geus kapake goblog!");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("purple","!] Sok daftar ulang bebel\n");
         }
//  }
